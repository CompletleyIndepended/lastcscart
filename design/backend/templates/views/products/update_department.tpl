...
<form action="{""|fn_url}" method="post" class="form-horizontal form-edit" name="department_form1" enctype="multipart/form-data">
    ...
    <div id="content_general">
        ...
        <div class="control-group">
            <label class="control-label">{__("managers")}</label>
            <div class="controls">
        ...
        {include file="common/pagination.tpl" div_id="pagination_contents_departments"}
         ...
         <div>
            <label class="control-label">{__("employeers")}</label>
            <div class="controls">
                {include 
                file="pickers/users/picker.tpl" 
                but_text= {__("add_employeers")}
                input_name="department_data[employeers_ids][]" 
                item_ids=$department_data.employeers_ids
                but_meta="btn"
                }
            </div>
        </div>
